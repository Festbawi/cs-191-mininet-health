        ...
        <div class="siimple-content siimple-content--large">
                            ...
                            %for i, adj_row in enumerate(adj['table']):
                                <div class="siimple-table-row">
                                    ...
                                    %for is_adjacent in adj_row:
                                        <div class="siimple-table-cell siimple--bg-{{'success' if is_adjacent else 'error'}}">{{is_adjacent}}</div>
                                    %end
                                </div>
                            %end
                            </div>
            ...
            <blockquote class="siimple-blockquote">
                ...
                %else:
                    ...
                    &emsp;<div id="adj-modal-open" class="siimple-btn siimple-btn--primary siimple-btn--small">View adjacency matrix</div><br/>
                    %if not net.links:
                        &emsp;<span class="siimple--text-italic">None</span>
                    %else:
